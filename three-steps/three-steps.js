/* ==========================================================================
   BUILD MARKER: v18-arrows-measured — search for this exact string
...
(function () {
  ...
  function positionGapArrows(root) {
    ...
    var gap1 = (steps[0].offsetTop + steps[0].offsetHeight + steps[1].offsetTop) / 2;
    var gap2 = (steps[1].offsetTop + steps[1].offsetHeight + steps[2].offsetTop) / 2;
