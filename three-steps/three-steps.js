/* ==========================================================================
   BUILD MARKER: v33-centered-head-arrows — search for this exact string
...
(function () {
  ...
  function render(root) {
    ...
    root.innerHTML =
      ...
      stepsHtml +
      '<div class="ts-junction" id="ts-junction-1"><span class="ts-junction-arrow"></span><span class="ts-junction-arrow"></span></div>' +
      '<div class="ts-junction" id="ts-junction-2"><span class="ts-junction-arrow"></span><span class="ts-junction-arrow"></span></div>' +
      "</div>" +
